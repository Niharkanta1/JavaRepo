...
public final class LC implements Externalizable {
  ...
  public boolean isNoCache() { return this.noCache; }
  
  public void setNoCache(boolean paramBoolean) { this.noCache = paramBoolean; }
  
  public final UnitValue getAlignX() { return this.alignX; }
  
  public final void setAlignX(UnitValue paramUnitValue) { this.alignX = paramUnitValue; }
  
  public final UnitValue getAlignY() { return this.alignY; }
  
  public final void setAlignY(UnitValue paramUnitValue) { this.alignY = paramUnitValue; }
  
  public final int getDebugMillis() { return this.debugMillis; }
  
  public final void setDebugMillis(int paramInt) { this.debugMillis = paramInt; }
  
  public final boolean isFillX() { return this.fillX; }
  
  public final void setFillX(boolean paramBoolean) { this.fillX = paramBoolean; }
  
  public final boolean isFillY() { return this.fillY; }
  
  public final void setFillY(boolean paramBoolean) { this.fillY = paramBoolean; }
  
  public final boolean isFlowX() { return this.flowX; }
  
  public final void setFlowX(boolean paramBoolean) { this.flowX = paramBoolean; }
  
  public final BoundSize getGridGapX() { return this.gridGapX; }
  
  public final void setGridGapX(BoundSize paramBoundSize) { this.gridGapX = paramBoundSize; }
  
  public final BoundSize getGridGapY() { return this.gridGapY; }
  
  public final void setGridGapY(BoundSize paramBoundSize) { this.gridGapY = paramBoundSize; }
  
  public final int getHideMode() { return this.hideMode; }
  ...
  public final Boolean getLeftToRight() { return this.leftToRight; }
  
  public final void setLeftToRight(Boolean paramBoolean) { this.leftToRight = paramBoolean; }
  
  public final boolean isNoGrid() { return this.noGrid; }
  
  public final void setNoGrid(boolean paramBoolean) { this.noGrid = paramBoolean; }
  
  public final boolean isTopToBottom() { return this.topToBottom; }
  
  public final void setTopToBottom(boolean paramBoolean) { this.topToBottom = paramBoolean; }
  
  public final boolean isVisualPadding() { return this.visualPadding; }
  
  public final void setVisualPadding(boolean paramBoolean) { this.visualPadding = paramBoolean; }
  
  public final int getWrapAfter() { return this.wrapAfter; }
  
  public final void setWrapAfter(int paramInt) { this.wrapAfter = paramInt; }
  
  public final BoundSize getPackWidth() { return this.packW; }
  
  public final void setPackWidth(BoundSize paramBoundSize) { this.packW = (paramBoundSize != null) ? paramBoundSize : BoundSize.NULL_SIZE; }
  
  public final BoundSize getPackHeight() { return this.packH; }
  
  public final void setPackHeight(BoundSize paramBoundSize) { this.packH = (paramBoundSize != null) ? paramBoundSize : BoundSize.NULL_SIZE; }
  
  public final float getPackHeightAlign() { return this.phAlign; }
  
  public final void setPackHeightAlign(float paramFloat) { this.phAlign = Math.max(0.0F, Math.min(1.0F, paramFloat)); }
  
  public final float getPackWidthAlign() { return this.pwAlign; }
  
  public final void setPackWidthAlign(float paramFloat) { this.pwAlign = Math.max(0.0F, Math.min(1.0F, paramFloat)); }
  
  public final BoundSize getWidth() { return this.width; }
  
  public final void setWidth(BoundSize paramBoundSize) { this.width = (paramBoundSize != null) ? paramBoundSize : BoundSize.NULL_SIZE; }
  
  public final BoundSize getHeight() { return this.height; }
  
  public final void setHeight(BoundSize paramBoundSize) { this.height = (paramBoundSize != null) ? paramBoundSize : BoundSize.NULL_SIZE; }
  
  public final LC pack() { return pack("pref", "pref"); }

...
public final class DimConstraint implements Externalizable {
  ...
  public int getGrowPriority() { return this.resize.growPrio; }
  
  public void setGrowPriority(int paramInt) { this.resize.growPrio = paramInt; }
  
  public Float getGrow() { return this.resize.grow; }
  
  public void setGrow(Float paramFloat) { this.resize.grow = paramFloat; }
  
  public int getShrinkPriority() { return this.resize.shrinkPrio; }
  
  public void setShrinkPriority(int paramInt) { this.resize.shrinkPrio = paramInt; }
  
  public Float getShrink() { return this.resize.shrink; }
  
  public void setShrink(Float paramFloat) { this.resize.shrink = paramFloat; }
  
  public UnitValue getAlignOrDefault(boolean paramBoolean) { return (this.align != null) ? this.align : (paramBoolean ? UnitValue.LEADING : ((this.fill || !PlatformDefaults.getDefaultRowAlignmentBaseline()) ? UnitValue.CENTER : UnitValue.BASELINE_IDENTITY)); }
  
  public UnitValue getAlign() { return this.align; }
  
  public void setAlign(UnitValue paramUnitValue) { this.align = paramUnitValue; }
  
  public BoundSize getGapAfter() { return this.gapAfter; }
  
  public void setGapAfter(BoundSize paramBoundSize) { this.gapAfter = paramBoundSize; }
  
  boolean hasGapAfter() { return (this.gapAfter != null && !this.gapAfter.isUnset()); }
  
  boolean isGapAfterPush() { return (this.gapAfter != null && this.gapAfter.getGapPush()); }
  
  public BoundSize getGapBefore() { return this.gapBefore; }
  
  public void setGapBefore(BoundSize paramBoundSize) { this.gapBefore = paramBoundSize; }
  
  boolean hasGapBefore() { return (this.gapBefore != null && !this.gapBefore.isUnset()); }
  
  boolean isGapBeforePush() { return (this.gapBefore != null && this.gapBefore.getGapPush()); }
  
  public BoundSize getSize() { return this.size; }
  ...
  public String getSizeGroup() { return this.sizeGroup; }
  
  public void setSizeGroup(String paramString) { this.sizeGroup = paramString; }
  
  public String getEndGroup() { return this.endGroup; }
  
  public void setEndGroup(String paramString) { this.endGroup = paramString; }
  
  public boolean isFill() { return this.fill; }
  
  public void setFill(boolean paramBoolean) { this.fill = paramBoolean; }
  
  public boolean isNoGrid() { return this.noGrid; }
  
  public void setNoGrid(boolean paramBoolean) { this.noGrid = paramBoolean; }
  ...
  int[] getComponentGaps(ContainerWrapper paramContainerWrapper, ComponentWrapper paramComponentWrapper1, BoundSize paramBoundSize, ComponentWrapper paramComponentWrapper2, String paramString, int paramInt1, int paramInt2, boolean paramBoolean) {
    ...
    boolean bool = (boundSize != null && boundSize.getGapPush()) ? 1 : 0;

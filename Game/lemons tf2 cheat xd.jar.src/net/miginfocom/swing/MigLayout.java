...
public final class MigLayout implements LayoutManager2, Externalizable {
  ...
  private final Map<ComponentWrapper, CC> ccMap = new HashMap(8);
  ...
  public MigLayout() { this("", "", ""); }
  
  public MigLayout(String paramString) { this(paramString, "", ""); }
  
  public MigLayout(String paramString1, String paramString2) { this(paramString1, paramString2, ""); }
  ...
  public MigLayout(LC paramLC) { this(paramLC, null, null); }
  
  public MigLayout(LC paramLC, AC paramAC) { this(paramLC, paramAC, null); }
  ...
  public Object getLayoutConstraints() { return this.layoutConstraints; }
  ...
  public Object getColumnConstraints() { return this.colConstraints; }
  ...
  public Object getRowConstraints() { return this.rowConstraints; }
  ...
  public Map<Component, Object> getConstraintMap() { return new IdentityHashMap(this.scrConstrMap); }
  ...
  public void setComponentConstraints(Component paramComponent, Object paramObject) { setComponentConstraintsImpl(paramComponent, paramObject, false); }
  ...
  public boolean isManagingComponent(Component paramComponent) { return this.scrConstrMap.containsKey(paramComponent); }
  
  public void addLayoutCallback(LayoutCallback paramLayoutCallback) {
    if (paramLayoutCallback == null)
      throw new NullPointerException(); 
    if (this.callbackList == null)
      this.callbackList = new ArrayList(true); 
  ...
  private boolean getDebug() { return (this.debugTimer != null); }
  ...
  private void checkCache(Container paramContainer) {
    ...
    setDebug(containerWrapper, (getDebugMillis() > 0));
    if (this.grid == null)
    ...
    synchronized (paramContainer.getTreeLock()) {
      ...
      if (this.lastSize != l) {
        ...
        if (window != null)
          if (window.isVisible()) {
            SwingUtilities.invokeLater(new Runnable() {
                  public void run() { MigLayout.this.adjustWindowSize(containerWrapper); }
                });
          } else {
  ...
  private int constrain(ContainerWrapper paramContainerWrapper, int paramInt1, int paramInt2, BoundSize paramBoundSize) {
    ...
    if (unitValue != null)
      i = unitValue.getPixels(paramInt2, paramContainerWrapper, paramContainerWrapper); 
  ...
  public Dimension maximumLayoutSize(Container paramContainer) { return new Dimension('翿', '翿'); }
  ...
  public float getLayoutAlignmentX(Container paramContainer) { return (this.lc != null && this.lc.getAlignX() != null) ? this.lc.getAlignX().getPixels(1.0F, checkParent(paramContainer), null) : 0.0F; }
  
  public float getLayoutAlignmentY(Container paramContainer) { return (this.lc != null && this.lc.getAlignY() != null) ? this.lc.getAlignY().getPixels(1.0F, checkParent(paramContainer), null) : 0.0F; }
  
  public void addLayoutComponent(String paramString, Component paramComponent) { addLayoutComponent(paramComponent, paramString); }
  ...
  public void invalidateLayout(Container paramContainer) { this.dirty = true; }
  
  private Object readResolve() { return LayoutUtil.getSerializedObject(this); }

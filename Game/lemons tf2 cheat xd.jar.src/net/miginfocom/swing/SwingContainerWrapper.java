...
public final class SwingContainerWrapper extends SwingComponentWrapper implements ContainerWrapper {
  private static final Color DB_CELL_OUTLINE = new Color('ÿ', false, false);
  
  public SwingContainerWrapper(Container paramContainer) { super(paramContainer); }
  ...
  public int getComponentCount() { return ((Container)getComponent()).getComponentCount(); }
  
  public Object getLayout() { return ((Container)getComponent()).getLayout(); }
  
  public final boolean isLeftToRight() { return ((Container)getComponent()).getComponentOrientation().isLeftToRight(); }
  ...
  public final void paintDebugCell(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    if (graphics2D == null)
      return; 
    graphics2D.setStroke(new BasicStroke(1.0F, 2, false, 10.0F, new float[] { 2.0F, 3.0F }, 0.0F));
    graphics2D.setPaint(DB_CELL_OUTLINE);
    graphics2D.drawRect(paramInt1, paramInt2, paramInt3 - 1, paramInt4 - 1);
  }
  
  public int getComponetType(boolean paramBoolean) { return 1; }

...
/*     */ 
/*     */   
/*  47 */   private static final Comparator<Object> COMPARATOR = new Comparator<Object>()
/*     */     {
/*  49 */       public int compare(Object o1, Object o2) { return ((Rectangle)o1).x - ((Rectangle)o2).x; }
/*     */     };
/*     */ 
/*     */ 
/*     */ 
...
/*     */           }
/*  95 */         } else if (sampleModel instanceof java.awt.image.SinglePixelPackedSampleModel && 
...
/* 132 */           if (startCol >= 0) {
/*     */             
/* 134 */             curLine.add(new Rectangle(startCol, row, firstByteCol - startCol, true));
/* 135 */             startCol = -1;
/*     */           } 
...
/*     */               
/* 155 */               curLine.add(new Rectangle(startCol, row, col - startCol, true));
/* 156 */               startCol = -1;
/*     */             } 
/*     */           } 
/*     */         } 
...
/* 162 */       if (startCol >= 0)
/*     */       {
/* 164 */         curLine.add(new Rectangle(startCol, row, w - startCol, true));
/*     */       }
...
/* 192 */     Set<Rectangle> rects = new HashSet<Rectangle>();
/* 193 */     Set<Rectangle> prevLine = Collections.EMPTY_SET;
/* 194 */     for (row = 0; row < h; row++) {
/* 195 */       Set<Rectangle> curLine = new TreeSet<Rectangle>(COMPARATOR);
...
/*     */           
/* 207 */           curLine.add(new Rectangle(startCol, row, col - startCol, true));
/* 208 */           startCol = -1;
/*     */         } 
/*     */       } 
/*     */       
/* 212 */       if (startCol >= 0)
/*     */       {
/* 214 */         curLine.add(new Rectangle(startCol, row, w - startCol, true));
/*     */       }
...
/* 232 */     Set<Rectangle> unmerged = new HashSet<Rectangle>(prev);
...
/* Location:              D:\CODING\JAVA\Game\lemons tf2 cheat xd.jar!\com\sun\jna\platform\RasterRangesUtils.class

...
/*    */   
/* 33 */   public static class PERF_DATA_BLOCK extends Structure { public char[] Signature = new char[4];
...
/* 41 */     public WinBase.SYSTEMTIME SystemTime = new WinBase.SYSTEMTIME();
/* 42 */     public WinNT.LARGE_INTEGER PerfTime = new WinNT.LARGE_INTEGER();
/* 43 */     public WinNT.LARGE_INTEGER PerfFreq = new WinNT.LARGE_INTEGER();
/* 44 */     public WinNT.LARGE_INTEGER PerfTime100nSec = new WinNT.LARGE_INTEGER();
/*    */     
/*    */     public int SystemNameLength;
/*    */     
/*    */     public int SystemNameOffset;
/*    */     
/* 50 */     protected List<String> getFieldOrder() { return Arrays.asList(new String[] { "Signature", "LittleEndian", "Version", "Revision", "TotalByteLength", "HeaderLength", "NumObjectTypes", "DefaultObject", "SystemTime", "PerfTime", "PerfFreq", "PerfTime100nSec", "SystemNameLength", "SystemNameOffset" }); } }
/*    */ 
/*    */ 
/*    */ 
/*    */   
...
/*    */ 
/*    */     
/* 72 */     protected List<String> getFieldOrder() { return Arrays.asList(new String[] { "ByteLength", "ParentObjectTitleIndex", "ParentObjectInstance", "UniqueID", "NameOffset", "NameLength" }); }
/*    */   } }


/* Location:              D:\CODING\JAVA\Game\lemons tf2 cheat xd.jar!\com\sun\jna\platform\win32\WinPerf.class

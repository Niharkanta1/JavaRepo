...
/*    */   
/* 55 */   protected List<String> getFieldOrder() { return Arrays.asList(new String[] { "QueryInterfaceCallback", "AddRefCallback", "ReleaseCallback", "GetTypeInfoCountCallback", "GetTypeInfoCallback", "GetIDsOfNamesCallback", "InvokeCallback" }); }
/*    */   
/*    */   public static interface InvokeCallback extends StdCallLibrary.StdCallCallback {
/*    */     WinNT.HRESULT invoke(Pointer param1Pointer, OaIdl.DISPID param1DISPID, Guid.GUID.ByValue param1ByValue, WinDef.LCID param1LCID, WinDef.WORD param1WORD, OleAuto.DISPPARAMS.ByReference param1ByReference, Variant.VARIANT.ByReference param1ByReference1, OaIdl.EXCEPINFO.ByReference param1ByReference2, IntByReference param1IntByReference);
/*    */   }
/*    */   
/*    */   public static interface GetIDsOfNamesCallback extends StdCallLibrary.StdCallCallback {
/*    */     WinNT.HRESULT invoke(Pointer param1Pointer, Guid.GUID.ByValue param1ByValue, WString[] param1ArrayOfWString, int param1Int, WinDef.LCID param1LCID, OaIdl.DISPIDByReference param1DISPIDByReference);
/*    */   }
/*    */   
...
/* Location:              D:\CODING\JAVA\Game\lemons tf2 cheat xd.jar!\com\sun\jna\platform\win32\COM\DispatchVTable.class

...
/*     */ {
/*  38 */   public static final int STRUCTURE_ALIGNMENT = Platform.is64Bit() ? 0 : 1;
/*     */   
...
/*     */     
/* 112 */     protected List getFieldOrder() { return Arrays.asList(new String[] { "hwnd", "wFunc", "pFrom", "pTo", "fFlags", "fAnyOperationsAborted", "pNameMappings", "lpszProgressTitle" }); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 122 */         encoded = encoded + paths[i];
/* 123 */         encoded = encoded + "\000";
/*     */       } 
/* 125 */       return encoded + "\000";
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 203 */     public APPBARDATA(Pointer p) { super(p); }
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 208 */     protected List getFieldOrder() { return Arrays.asList(new String[] { "cbSize", "hWnd", "uCallbackMessage", "uEdge", "rc", "lParam" }); }
/*     */   }
/*     */ }


/* Location:              D:\CODING\JAVA\Game\lemons tf2 cheat xd.jar!\com\sun\jna\platform\win32\ShellAPI.class

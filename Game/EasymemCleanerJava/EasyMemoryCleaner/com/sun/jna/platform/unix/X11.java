...
/*   40 */     public VisualID(long value) { super(value, true); }
/*      */     protected boolean isNone(Object o) {
/*   42 */       return (o == null || (o instanceof Number && ((Number)o)
/*      */         
/*   44 */         .longValue() == 0L));
/*      */     }
/*      */     public Object fromNative(Object nativeValue, FromNativeContext context) {
/*   47 */       if (isNone(nativeValue))
/*   48 */         return None; 
...
/*   57 */     public XID(long id) { super(id, true); }
/*      */     protected boolean isNone(Object o) {
/*   59 */       return (o == null || (o instanceof Number && ((Number)o)
/*      */         
/*   61 */         .longValue() == 0L));
/*      */     }
/*      */     public Object fromNative(Object nativeValue, FromNativeContext context) {
/*   64 */       if (isNone(nativeValue))
/*   65 */         return None; 
...
/*  158 */     public AtomByReference() { super(X11.XID.SIZE); }
/*      */     public X11.Atom getValue() {
/*  160 */       NativeLong value = getPointer().getNativeLong(0L);
/*  161 */       return (X11.Atom)(new X11.Atom()).fromNative(value, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public static class Colormap extends XID { private static final long serialVersionUID = 1L;
/*  166 */     public static final Colormap None = null;
/*      */     public Colormap() {}
/*  168 */     public Colormap(long id) { super(id); }
/*      */     public Object fromNative(Object nativeValue, FromNativeContext context) {
/*  170 */       if (isNone(nativeValue))
/*  171 */         return None; 
...
/*      */     public Font() {}
/*  179 */     public Font(long id) { super(id); }
/*      */     public Object fromNative(Object nativeValue, FromNativeContext context) {
/*  181 */       if (isNone(nativeValue))
/*  182 */         return None; 
/*  183 */       return new Font(((Number)nativeValue).longValue());
/*      */     }
/*      */   }
/*      */   
/*      */   public static class Cursor extends XID { private static final long serialVersionUID = 1L;
/*  188 */     public static final Cursor None = null;
/*      */     public Cursor() {}
/*  190 */     public Cursor(long id) { super(id); }
/*      */     public Object fromNative(Object nativeValue, FromNativeContext context) {
/*  192 */       if (isNone(nativeValue))
/*  193 */         return None; 
...
/*      */     public KeySym() {}
/*  201 */     public KeySym(long id) { super(id); }
/*      */     public Object fromNative(Object nativeValue, FromNativeContext context) {
/*  203 */       if (isNone(nativeValue))
/*  204 */         return None; 
/*  205 */       return new KeySym(((Number)nativeValue).longValue());
/*      */     }
/*      */   }
/*      */   
/*      */   public static class Drawable extends XID { private static final long serialVersionUID = 1L;
/*  210 */     public static final Drawable None = null;
/*      */     public Drawable() {}
/*  212 */     public Drawable(long id) { super(id); }
/*      */     public Object fromNative(Object nativeValue, FromNativeContext context) {
/*  214 */       if (isNone(nativeValue))
/*  215 */         return None; 
...
/*      */     public Window() {}
/*  223 */     public Window(long id) { super(id); }
/*      */     public Object fromNative(Object nativeValue, FromNativeContext context) {
/*  225 */       if (isNone(nativeValue))
/*  226 */         return None; 
/*  227 */       return new Window(((Number)nativeValue).longValue());
/*      */     }
/*      */   }
/*      */   
/*  231 */   public static class WindowByReference extends ByReference { public WindowByReference() { super(X11.XID.SIZE); }
/*      */     public X11.Window getValue() {
/*  233 */       NativeLong value = getPointer().getNativeLong(0L);
...
/*      */     public Pixmap() {}
/*  241 */     public Pixmap(long id) { super(id); }
/*      */     public Object fromNative(Object nativeValue, FromNativeContext context) {
...
/*  253 */       if (getPointer() != null)
/*  254 */         return new X11.VisualID(getPointer().getNativeLong(Native.POINTER_SIZE).longValue()); 
...
/*  270 */     public static final Xext INSTANCE = (Xext)Native.loadLibrary("Xext", Xext.class);
/*      */     
...
/*      */     extends Library
/*      */   {
/*  288 */     public static final Xrender INSTANCE = (Xrender)Native.loadLibrary("Xrender", Xrender.class); public static final int PictTypeIndexed = 0; public static final int PictTypeDirect = 1;
/*      */     XRenderPictFormat XRenderFindVisualFormat(X11.Display param1Display, X11.Visual param1Visual);
/*      */     public static class XRenderDirectFormat extends Structure { public short red; public short redMask; public short green; public short greenMask; public short blue;
...
/*      */       private static final long serialVersionUID = 1L;
/*  300 */       public static final PictFormat None = null;
/*  301 */       public PictFormat(long value) { super(value); }
/*  302 */       public PictFormat() { this(0L); }
/*      */       public Object fromNative(Object nativeValue, FromNativeContext context) {
/*  304 */         if (isNone(nativeValue))
/*  305 */           return None; 
...
/*      */     extends Library
/*      */   {
/*  327 */     public static final Xevie INSTANCE = (Xevie)Native.loadLibrary("Xevie", Xevie.class);
...
/*      */     extends Library {
/*  344 */     public static final XTest INSTANCE = (XTest)Native.loadLibrary("Xtst", XTest.class);
...
/*      */   
/*      */   public static class XInputClassInfoByReference extends Structure implements Structure.ByReference { public byte input_class;
...
/*      */ 
/*      */   
/*  380 */   public static final X11 INSTANCE = (X11)Native.loadLibrary("X11", X11.class); public static final int XK_0 = 48; public static final int XK_9 = 57; public static final int XK_A = 65; public static final int XK_Z = 90; public static final int XK_a = 97; public static final int XK_z = 122; public static final int XK_Shift_L = 65505; public static final int XK_Shift_R = 65505; public static final int XK_Control_L = 65507; public static final int XK_Control_R = 65508; public static final int XK_CapsLock = 65509; public static final int XK_ShiftLock = 65510; public static final int XK_Meta_L = 65511;
...
/*      */   
/*      */   public static class XWMHints extends Structure { public NativeLong flags;
...
/*      */       public int y;
/*      */       
/*  455 */       protected List getFieldOrder() { return Arrays.asList(new String[] { "x", "y" }); }
/*      */     }
/*      */ 
/*      */ 
/*      */ 
/*      */     
/*  461 */     protected List getFieldOrder() { return Arrays.asList(new String[] { "flags", "x", "y", "width", "height", "min_width", "min_height", "max_width", "max_height", "width_inc", "height_inc", "min_aspect", "max_aspect", "base_width", "base_height", "win_gravity" }); }
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*      */ 
/*      */     
/*  556 */     protected List getFieldOrder() { return Arrays.asList(new String[] { "background_pixmap", "background_pixel", "border_pixmap", "border_pixel", "bit_gravity", "win_gravity", "backing_store", "backing_planes", "backing_pixel", "save_under", "event_mask", "do_not_propagate_mask", "override_redirect", "colormap", "cursor" }); }
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     public Data data;
/*      */     
/* 1496 */     protected List getFieldOrder() { return Arrays.asList(new String[] { "type", "serial", "send_event", "display", "window", "message_type", "format", "data" }); }
/*      */     
...
/*      */     public int state;
/*      */     
/* 1549 */     protected List getFieldOrder() { return Arrays.asList(new String[] { "type", "serial", "send_event", "display", "window", "root", "subwindow", "time", "x", "y", "x_root", "y_root", "mode", "detail", "same_screen", "focus", "state" }); }
/*      */   }
/*      */ 
/*      */   
...
/*      */     public int minor_code;
/*      */     
/* 1622 */     protected List getFieldOrder() { return Arrays.asList(new String[] { "type", "serial", "send_event", "display", "drawable", "major_code", "minor_code" }); }
/*      */   }
/*      */   
...
/*      */     public int override_redirect;
/*      */     
/* 1687 */     protected List getFieldOrder() { return Arrays.asList(new String[] { "type", "serial", "send_event", "display", "event", "window", "override_redirect" }); }
/*      */   }
/*      */   
...
/*      */     public int place;
/*      */     
/* 1787 */     protected List getFieldOrder() { return Arrays.asList(new String[] { "type", "serial", "send_event", "display", "event", "window", "place" }); }
/*      */   }
/*      */   
...
/*      */     public int state;
/*      */     
/* 1814 */     protected List getFieldOrder() { return Arrays.asList(new String[] { "type", "serial", "send_event", "display", "window", "atom", "time", "state" }); }
/*      */   }
/*      */   
...
/*      */     public NativeLong time;
/*      */     
/* 1843 */     protected List getFieldOrder() { return Arrays.asList(new String[] { "type", "serial", "send_event", "display", "owner", "requestor", "selection", "target", "property", "time" }); }
/*      */   }
/*      */   
...
/*      */     public int state;
/*      */     
/* 1872 */     protected List getFieldOrder() { return Arrays.asList(new String[] { "type", "serial", "send_event", "display", "window", "colormap", "c_new", "state" }); }
/*      */   }
/*      */   
...
/*      */     
/* 1899 */     protected List getFieldOrder() { return Arrays.asList(new String[] { "type", "display", "serial", "error_code", "request_code", "minor_code", "resourceid" }); }
/*      */   }
/*      */   
...
/*      */ 
/*      */     
/* 2208 */     protected List getFieldOrder() { return Arrays.asList(new String[] { "max_keypermod", "modifiermap" }); }
/*      */   }
/*      */ 
/*      */   
...
/*      */     
/* 2231 */     protected List getFieldOrder() { return Arrays.asList(new String[] { "key_click_percent", "bell_percent", "bell_pitch", "bell_duration", "led", "led_mode", "key", "auto_repeat_mode" }); }
/*      */ 
/*      */ 
/*      */     
/* 2235 */     public String toString() { return "XKeyboardControlByReference{key_click_percent=" + this.key_click_percent + ", bell_percent=" + this.bell_percent + ", bell_pitch=" + this.bell_pitch + ", bell_duration=" + this.bell_duration + ", led=" + this.led + ", led_mode=" + this.led_mode + ", key=" + this.key + ", auto_repeat_mode=" + this.auto_repeat_mode + '}'; }
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*      */ 
/*      */     
/* 2265 */     protected List getFieldOrder() { return Arrays.asList(new String[] { "key_click_percent", "bell_percent", "bell_pitch", "bell_duration", "led_mask", "global_auto_repeat", "auto_repeats" }); }
/*      */ 
/*      */ 
/*      */     
/* 2269 */     public String toString() { return "XKeyboardStateByReference{key_click_percent=" + this.key_click_percent + ", bell_percent=" + this.bell_percent + ", bell_pitch=" + this.bell_pitch + ", bell_duration=" + this.bell_duration + ", led_mask=" + this.led_mask + ", global_auto_repeat=" + this.global_auto_repeat + ", auto_repeats=" + this.auto_repeats + '}'; }
/*      */   }
/*      */ }


/* Location:              D:\CODING\JAVA\Game\lemons tf2 cheat xd.jar!\com\sun\jna\platfor\\unix\X11.class

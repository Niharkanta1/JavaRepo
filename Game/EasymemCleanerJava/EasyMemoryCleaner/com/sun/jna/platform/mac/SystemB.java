...
/*  63 */   public static class HostCpuLoadInfo extends Structure { public int[] cpu_ticks = new int[4];
/*     */ 
/*     */     
...
/*     */     extends Structure {
/*  71 */     public int[] avenrun = new int[3];
/*  72 */     public int[] mach_factor = new int[3];
/*     */ 
/*     */     
/*  75 */     protected List<String> getFieldOrder() { return Arrays.asList(new String[] { "avenrun", "mach_factor" }); }
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/*  98 */     protected List<String> getFieldOrder() { return Arrays.asList(new String[] { "free_count", "active_count", "inactive_count", "wire_count", "zero_fill_count", "reactivations", "pageins", "pageouts", "faults", "cow_faults", "lookups", "hits", "purgeable_count", "purges", "speculative_count" }); }
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/* 140 */     protected List<String> getFieldOrder() { return Arrays.asList(new String[] { "free_count", "active_count", "inactive_count", "wire_count", "zero_fill_count", "reactivations", "pageins", "pageouts", "faults", "cow_faults", "lookups", "hits", "purges", "purgeable_count", "speculative_count", "decompressions", "compressions", "swapins", "swapouts", "compressor_page_count", "throttled_count", "external_page_count", "internal_page_count", "total_uncompressed_pages_in_compressor" }); }
/*     */   }
/*     */ }


/* Location:              D:\CODING\JAVA\Game\lemons tf2 cheat xd.jar!\com\sun\jna\platform\mac\SystemB.class

...
/*  45 */         throw new UnsupportedOperationException("No support (yet) for " + 
/*  46 */             System.getProperty("os.name"));
/*     */       } 
/*     */       
...
/*     */ 
/*     */   
/*  54 */   public static boolean isPressed(int keycode, int location) { return INSTANCE.isPressed(keycode, location); }
/*     */ 
/*     */   
...
/*  67 */     private W32KeyboardUtils() { super(null); }
/*     */     private int toNative(int code, int loc) {
/*  69 */       if ((code >= 65 && code <= 90) || (code >= 48 && code <= 57))
/*     */       {
/*  71 */         return code;
/*     */       }
/*  73 */       if (code == 16) {
...
/* 103 */       User32 lib = User32.INSTANCE;
/* 104 */       return ((lib.GetAsyncKeyState(toNative(keycode, location)) & 0x8000) != 0);
/*     */     } }
/*     */   
/* 107 */   private static class MacKeyboardUtils extends NativeKeyboardUtils { private MacKeyboardUtils() { super(null); }
/*     */     
...
/* 112 */     private X11KeyboardUtils() { super(null); }
/*     */ 
/*     */     
...
/*     */     }
/*     */     public boolean isPressed(int keycode, int location) {
/* 143 */       lib = X11.INSTANCE;
/* 144 */       dpy = lib.XOpenDisplay(null);
/* 145 */       if (dpy == null) {
...
/* Location:              D:\CODING\JAVA\Game\lemons tf2 cheat xd.jar!\com\sun\jna\platform\KeyboardUtils.class

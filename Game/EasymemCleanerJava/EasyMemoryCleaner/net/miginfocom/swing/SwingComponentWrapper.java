...
public class SwingComponentWrapper implements ComponentWrapper {
  ...
  private static final Color DB_COMP_OUTLINE = new Color(false, false, 'È');
  ...
  private static final Font SUBST_FONT = new Font("sansserif", false, 11);
  ...
  public SwingComponentWrapper(Component paramComponent) { this.c = paramComponent; }
  ...
  public final Object getComponent() { return this.c; }
  ...
  public final float getPixelUnitFactor(boolean paramBoolean) {
    ...
    switch (PlatformDefaults.getLogicalPixelBase()) {
      case 100:
        ...
        float = (Point2D.Float)FM_MAP.get(fontMetrics);
        if (float == null) {
          Rectangle2D rectangle2D = fontMetrics.getStringBounds("X", this.c.getGraphics());
          float = new Point2D.Float((float)rectangle2D.getWidth() / 6.0F, (float)rectangle2D.getHeight() / 13.277344F);
          FM_MAP.put(fontMetrics, float);
        } 
        return paramBoolean ? float.x : float.y;
      case 101:
        float1 = paramBoolean ? PlatformDefaults.getHorizontalScaleFactor() : PlatformDefaults.getVerticalScaleFactor();
        return (float1 != null) ? float1.floatValue() : ((paramBoolean ? getHorizontalScreenDPI() : getVerticalScreenDPI()) / PlatformDefaults.getDefaultDPI());
    } 
    return 1.0F;
  }
  
  public final int getX() { return this.c.getX(); }
  
  public final int getY() { return this.c.getY(); }
  
  public final int getHeight() { return this.c.getHeight(); }
  
  public final int getWidth() { return this.c.getWidth(); }
  ...
  public final int getMaximumHeight(int paramInt) { return !isMaxSet(this.c) ? 32767 : (this.c.getMaximumSize()).height; }
  
  public final int getMaximumWidth(int paramInt) { return !isMaxSet(this.c) ? 32767 : (this.c.getMaximumSize()).width; }
  ...
  public final int getHorizontalScreenDPI() { return PlatformDefaults.getDefaultDPI(); }
  
  public final int getVerticalScreenDPI() { return PlatformDefaults.getDefaultDPI(); }
  ...
  public final String getLinkId() { return this.c.getName(); }
  
  public final void setBounds(int paramInt1, int paramInt2, int paramInt3, int paramInt4) { this.c.setBounds(paramInt1, paramInt2, paramInt3, paramInt4); }
  
  public boolean isVisible() { return this.c.isVisible(); }
  
  public final int[] getVisualPadding() { return (vp && this.c instanceof javax.swing.JTabbedPane && UIManager.getLookAndFeel().getClass().getName().endsWith("WindowsLookAndFeel")) ? new int[] { -1, 0, 2, 2 } : null; }
  
  public static boolean isMaxSizeSetOn1_4() { return maxSet; }
  
  public static void setMaxSizeSetOn1_4(boolean paramBoolean) { maxSet = paramBoolean; }
  
  public static boolean isVisualPaddingEnabled() { return vp; }
  
  public static void setVisualPaddingEnabled(boolean paramBoolean) { vp = paramBoolean; }
  ...
  public final void paintDebugOutline() {
    ...
    graphics2D.setStroke(new BasicStroke(1.0F, 2, false, 10.0F, new float[] { 2.0F, 4.0F }, 0.0F));
  ...
  public final int hashCode() { return getComponent().hashCode(); }
  
  public final boolean equals(Object paramObject) { return !(paramObject instanceof ComponentWrapper) ? false : getComponent().equals(((ComponentWrapper)paramObject).getComponent()); }

...
public interface ITypeLib extends IUnknown {
  ...
  WinNT.HRESULT FindName(WTypes.BSTRByReference paramBSTRByReference, WinDef.ULONG paramULONG, ITypeInfo[] paramArrayOfITypeInfo, OaIdl.MEMBERID[] paramArrayOfMEMBERID, WinDef.USHORTByReference paramUSHORTByReference);
  
  void ReleaseTLibAttr(OaIdl.TLIBATTR paramTLIBATTR);
}


/* Location:              D:\CODING\JAVA\Game\lemons tf2 cheat xd.jar!\com\sun\jna\platform\win32\COM\ITypeLib.class

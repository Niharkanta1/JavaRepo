...
/*     */ 
/*     */         
/*  66 */         public Dimension getPreferredSize() { return new Dimension(icon.getIconWidth(), icon.getIconHeight()); }
/*     */ 
/*     */         
...
/*     */       {
/*  79 */         public int getIconHeight() { return icon.getIconHeight(); }
/*     */ 
/*     */         
...
/*     */           
/*  88 */           area.subtract(new Area(new Rectangle(x + this.val$cursorOffset.x - 1, y + this.val$cursorOffset.y - 1, 3, 3)));
/*  89 */           g.setClip(area);
...
/*     */ 
/*     */   
/* 106 */   public void setAlpha(float alpha) { WindowUtils.setWindowAlpha(this.dragImage, alpha); }
/*     */ 
/*     */ 
/*     */   
/*     */   public void dispose() {
...
/* Location:              D:\CODING\JAVA\Game\lemons tf2 cheat xd.jar!\com\sun\jna\platform\dnd\GhostedDragImage.class

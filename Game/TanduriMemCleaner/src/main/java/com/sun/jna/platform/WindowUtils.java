...
/*      */ 
/*      */     
/*  182 */     public boolean isVisible() { return this.packed; }
/*      */ 
/*      */ 
/*      */     
/*  186 */     public Rectangle getBounds() { return getOwner().getBounds(); }
/*      */   }
/*      */   
...
/*      */     {
/*  201 */       public void windowOpened(WindowEvent e) { WindowUtils.RepaintTrigger.this.repaint(); }
/*      */ 
/*      */       
...
/*      */ 
/*      */       
/*  214 */       public void componentShown(ComponentEvent e) { WindowUtils.RepaintTrigger.this.repaint(); }
/*      */ 
/*      */ 
/*      */       
/*  218 */       public void hierarchyChanged(HierarchyEvent e) { WindowUtils.RepaintTrigger.this.repaint(); }
/*      */ 
/*      */       
...
/*  236 */       this.listener = createListener();
/*      */ 
/*      */ 
/*      */       
...
/*      */ 
/*      */     
/*  278 */     protected Listener createListener() { return new Listener(); }
/*      */   }
/*      */   
...
/*      */       }
/*      */       public void removeNotify() {
/*  301 */         Toolkit.getDefaultToolkit().removeAWTEventListener(this);
/*  302 */         super.removeNotify();
/*      */       }
/*      */       public void setTransparent(boolean transparent) {
/*  305 */         this.transparent = transparent;
...
/*      */ 
/*      */     
/*  350 */     protected Window getWindow(Component c) { return (c instanceof Window) ? (Window)c : 
/*  351 */         SwingUtilities.getWindowAncestor(c); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  377 */                 if ((e.getChangeFlags() & 0x2L) != 0L && e
/*  378 */                   .getComponent().isDisplayable()) {
...
/*  409 */       if (mask != null) {
/*      */         
/*  411 */         Rectangle bounds = new Rectangle(false, false, mask.getIconWidth(), mask.getIconHeight());
...
/*  426 */       final Area area = new Area(new Rectangle(false, false, false, false));
...
/*      */ 
/*      */     
/*  446 */     public boolean isWindowAlphaSupported() { return false; }
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  483 */       Color bg = transparent ? new Color(false, false, false, false) : null;
...
/*      */ 
/*      */     
/*  526 */     protected void setMask(Component c, Raster raster) { throw new UnsupportedOperationException("Window masking is not available"); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*  542 */     public void setWindowMask(Component w, Shape mask) { setWindowMask(w, toRaster(mask)); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*  550 */     public void setWindowMask(Component w, Icon mask) { setWindowMask(w, toRaster(w, mask)); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*  589 */     protected BufferedImage getWindowIcon(WinDef.HWND hwnd) { throw new UnsupportedOperationException("This platform is not supported, yet."); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*  605 */     protected Dimension getIconSize(WinDef.HICON hIcon) { throw new UnsupportedOperationException("This platform is not supported, yet."); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*  626 */     protected List<DesktopWindow> getAllWindows(boolean onlyVisibleWindows) { throw new UnsupportedOperationException("This platform is not supported, yet."); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*  642 */     protected String getWindowTitle(WinDef.HWND hwnd) { throw new UnsupportedOperationException("This platform is not supported, yet."); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*  659 */     protected String getProcessFilePath(WinDef.HWND hwnd) { throw new UnsupportedOperationException("This platform is not supported, yet."); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*  674 */     protected Rectangle getWindowLocationAndSize(WinDef.HWND hwnd) { throw new UnsupportedOperationException("This platform is not supported, yet."); }
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*      */       } else {
/*      */         
/*  699 */         os = System.getProperty("os.name");
...
/*      */ 
/*      */   
/*  706 */   private static NativeWindowUtils getInstance() { return Holder.INSTANCE; }
/*      */   
...
/*      */ 
/*      */     
/*  721 */     public boolean isWindowAlphaSupported() { return Boolean.getBoolean("sun.java2d.noddraw"); }
/*      */ 
/*      */ 
/*      */     
...
/*      */       
/*  803 */       public W32TransparentContentPane(Container content) { super(WindowUtils.W32WindowUtils.this, content); }
/*      */       
...
/*      */       }
/*      */       public void setTransparent(boolean transparent) {
/*  821 */         super.setTransparent(transparent);
/*  822 */         if (!transparent) {
...
/*  829 */         gdi = GDI32.INSTANCE;
/*  830 */         user = User32.INSTANCE;
/*  831 */         int x = bounds.x;
/*  832 */         int y = bounds.y;
...
/*      */           
/*      */           try {
/*  894 */             if (user.GetLayeredWindowAttributes(hWnd, null, bref, iref) && (iref
/*  895 */               .getValue() & 0x2) != 0) {
/*  896 */               level = bref.getValue();
/*      */             }
/*      */           }
/*  899 */           catch (UnsatisfiedLinkError e) {}
/*      */           
...
/*  996 */       List<WinDef.POINT> points = new ArrayList<WinDef.POINT>();
/*  997 */       int size = 0;
/*  998 */       List<Integer> sizes = new ArrayList<Integer>();
/*  999 */       while (!pi.isDone()) {
...
/* 1015 */         pi.next();
/*      */       } 
/* 1017 */       POINT[] lppt = (POINT[])(new WinDef.POINT()).toArray(points.size());
/* 1018 */       POINT[] pts = (POINT[])points.toArray(new WinDef.POINT[points.size()]);
/* 1019 */       for (i = 0; i < lppt.length; i++) {
...
/* 1093 */       Memory memory1 = new Memory(lpBitsColor.length);
/* 1094 */       byte[] lpBitsMask = new byte[width * height * 24 / 8];
/* 1095 */       Memory memory2 = new Memory(lpBitsMask.length);
...
/* 1111 */       iconInfo.read();
/* 1112 */       GDI32.INSTANCE.GetDIBits(hDC, iconInfo.hbmColor, 0, height, memory1, bitmapInfo, 0);
/*      */       
/* 1114 */       memory1.read(0L, lpBitsColor, 0, lpBitsColor.length);
/* 1115 */       GDI32.INSTANCE.GetDIBits(hDC, iconInfo.hbmMask, 0, height, memory2, bitmapInfo, 0);
/*      */       
/* 1117 */       memory2.read(0L, lpBitsMask, 0, lpBitsMask.length);
/* 1118 */       BufferedImage image = new BufferedImage(width, height, 2);
/*      */ 
/*      */ 
/*      */       
/* 1122 */       int x = 0, y = height - 1; int i;
/* 1123 */       for (i = 0; i < lpBitsColor.length; i += 3) {
/* 1124 */         int b = lpBitsColor[i] & 0xFF;
/* 1125 */         int g = lpBitsColor[i + 1] & 0xFF;
/* 1126 */         int r = lpBitsColor[i + 2] & 0xFF;
/* 1127 */         int a = 'ÿ' - lpBitsMask[i] & 0xFF;
...
/* 1142 */       iconInfo = new WinGDI.ICONINFO();
/*      */       try {
...
/* 1149 */         if (iconInfo.hbmColor != null && iconInfo.hbmColor
/* 1150 */           .getPointer() != Pointer.NULL) {
/* 1151 */           int nWrittenBytes = GDI32.INSTANCE.GetObject(iconInfo.hbmColor, bmp
/* 1152 */               .size(), bmp.getPointer());
/* 1153 */           bmp.read();
/* 1154 */           if (nWrittenBytes > 0)
/* 1155 */             return new Dimension(bmp.bmWidth.intValue(), bmp.bmHeight
/* 1156 */                 .intValue()); 
/* 1157 */         } else if (iconInfo.hbmMask != null && iconInfo.hbmMask
/* 1158 */           .getPointer() != Pointer.NULL) {
...
/*      */         } 
/*      */       } finally {
/* 1166 */         if (iconInfo.hbmColor != null && iconInfo.hbmColor
/* 1167 */           .getPointer() != Pointer.NULL)
/* 1168 */           GDI32.INSTANCE.DeleteObject(iconInfo.hbmColor); 
/* 1169 */         if (iconInfo.hbmMask != null && iconInfo.hbmMask
/* 1170 */           .getPointer() != Pointer.NULL) {
...
/* 1180 */       final List<DesktopWindow> result = new LinkedList<DesktopWindow>();
/*      */       
...
/* 1222 */       char[] filePath = new char[1025];
...
/*      */           
/* 1228 */           .getValue());
/* 1229 */       if (process == null && Kernel32.INSTANCE
/* 1230 */         .GetLastError() != 5) {
...
/*      */       
/* 1235 */       if (length == 0 && Kernel32.INSTANCE
/* 1236 */         .GetLastError() != 6) {
...
/*      */       }
/* 1248 */       return new Rectangle(lpRect.left, lpRect.top, Math.abs(lpRect.right - lpRect.left), 
/* 1249 */           Math.abs(lpRect.bottom - lpRect.top));
/*      */     } }
/*      */   
...
/* 1264 */         if (oldContent instanceof OSXMaskingContentPane) {
/* 1265 */           content = (OSXMaskingContentPane)oldContent;
/*      */         } else {
/*      */           
/* 1268 */           content = new OSXMaskingContentPane(oldContent);
/*      */           
...
/* 1275 */         if (oldContent instanceof OSXMaskingContentPane) {
...
/*      */               try {
/* 1335 */                 peer.getClass().getMethod("setAlpha", new Class[] { float.class
/*      */                     
/* 1337 */                     }).invoke(peer, new Object[] { new Float(alpha) });
/*      */ 
/*      */               
/*      */               }
...
/*      */       } else {
/*      */         
/* 1352 */         setWindowMask(w, new Rectangle(false, false, w.getWidth(), w
/* 1353 */               .getHeight()));
/*      */       } 
/*      */     }
/*      */     
...
/*      */         }
/* 1412 */         w.setBackground(new Color(false, false, false, false));
/*      */       
/*      */       }
...
/* 1442 */       gc = x11.XCreateGC(dpy, pm, new NativeLong(0L), null);
/* 1443 */       if (gc == null) {
/* 1444 */         return null;
/*      */       }
/* 1446 */       x11.XSetForeground(dpy, gc, new NativeLong(0L));
/* 1447 */       x11.XFillRectangle(dpy, pm, gc, 0, 0, width, height);
/* 1448 */       final List<Rectangle> rlist = new ArrayList<Rectangle>();
/*      */       try {
/* 1450 */         RasterRangesUtils.outputOccupiedRanges(raster, new RasterRangesUtils.RangesOutput() {
/*      */               public boolean outputRange(int x, int y, int w, int h) {
/* 1452 */                 rlist.add(new Rectangle(x, y, w, h));
/* 1453 */                 return true;
/*      */               }
/*      */             });
/*      */         
/* 1457 */         XRectangle[] rects = (XRectangle[])(new X11.XRectangle()).toArray(rlist.size());
...
/*      */ 
/*      */     
/* 1484 */     private long[] alphaVisualIDs = new long[0]; private static final long OPAQUE = 4294967295L;
...
/*      */ 
/*      */     
/*      */     private long[] getAlphaVisualIDs() {
/* 1533 */       if (this.didCheck) {
/* 1534 */         return this.alphaVisualIDs;
/*      */       }
/* 1536 */       this.didCheck = true;
/* 1537 */       x11 = X11.INSTANCE;
/* 1538 */       dpy = x11.XOpenDisplay(null);
/* 1539 */       if (dpy == null)
...
/* 1553 */         if (info != null) {
/* 1554 */           List<X11.VisualID> list = new ArrayList<X11.VisualID>();
/*      */           
/* 1556 */           XVisualInfo[] infos = (XVisualInfo[])info.toArray(pcount.getValue());
/* 1557 */           for (i = 0; i < infos.length; i++) {
/*      */             
...
/* 1594 */         int arrayOfInt[] = ids, i = arrayOfInt.length; boolean bool = false; if (bool < i) { int id = arrayOfInt[bool];
/*      */           
...
/*      */           public void run() {
/* 1627 */             x11 = X11.INSTANCE;
/* 1628 */             dpy = x11.XOpenDisplay(null);
/* 1629 */             if (dpy == null)
/*      */               return; 
/*      */             try {
...
/*      */               else {
/*      */                 
/* 1639 */                 int opacity = (int)((long)(alpha * 4.2949673E9F) & 0xFFFFFFFFFFFFFFFFL);
...
/* 1661 */         super(WindowUtils.X11WindowUtils.this, oldContent);
/*      */ 
/*      */ 
/*      */ 
/*      */         
/* 1666 */         this.pixel = new int[4];
/*      */       }
/*      */       private int[] pixels; private final int[] pixel;
/*      */       
/*      */       protected void paintDirect(BufferedImage buf, Rectangle bounds) {
...
/*      */           public void run() {
/* 1759 */             x11 = X11.INSTANCE;
/* 1760 */             dpy = x11.XOpenDisplay(null);
/* 1761 */             if (dpy == null) {
/*      */               return;
/*      */             }
/* 1764 */             pm = null;
...
/*      */           {
/* 1788 */             public X11.Pixmap getPixmap(X11.Display dpy, X11.Window win) { return (raster != null) ? WindowUtils.X11WindowUtils.createBitmap(dpy, win, raster) : null; }
/*      */           });
/*      */     }
/*      */     
...
/*      */   }
/*      */   
/* 1800 */   public static void setWindowMask(Window w, Shape mask) { getInstance().setWindowMask(w, mask); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1809 */   public static void setComponentMask(Component c, Shape mask) { getInstance().setWindowMask(c, mask); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1818 */   public static void setWindowMask(Window w, Icon mask) { getInstance().setWindowMask(w, mask); }
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 1823 */   public static boolean isWindowAlphaSupported() { return getInstance().isWindowAlphaSupported(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1831 */   public static GraphicsConfiguration getAlphaCompatibleGraphicsConfiguration() { return getInstance().getAlphaCompatibleGraphicsConfiguration(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1849 */   public static void setWindowAlpha(Window w, float alpha) { getInstance().setWindowAlpha(w, Math.max(0.0F, Math.min(alpha, 1.0F))); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1865 */   public static void setWindowTransparent(Window w, boolean transparent) { getInstance().setWindowTransparent(w, transparent); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1878 */   public static BufferedImage getWindowIcon(WinDef.HWND hwnd) { return getInstance().getWindowIcon(hwnd); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1890 */   public static Dimension getIconSize(WinDef.HICON hIcon) { return getInstance().getIconSize(hIcon); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1908 */   public static List<DesktopWindow> getAllWindows(boolean onlyVisibleWindows) { return getInstance().getAllWindows(onlyVisibleWindows); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1921 */   public static String getWindowTitle(WinDef.HWND hwnd) { return getInstance().getWindowTitle(hwnd); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1935 */   public static String getProcessFilePath(WinDef.HWND hwnd) { return getInstance().getProcessFilePath(hwnd); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1947 */   public static Rectangle getWindowLocationAndSize(WinDef.HWND hwnd) { return getInstance().getWindowLocationAndSize(hwnd); }
/*      */ }


/* Location:              D:\CODING\JAVA\Game\lemons tf2 cheat xd.jar!\com\sun\jna\platform\WindowUtils.class

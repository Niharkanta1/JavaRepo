...
public final class UnitValue implements Serializable {
  ...
  private final UnitValue[] subUnits;
  
  private static final float[] SCALE;
  
  private static final long serialVersionUID = 1L;
  
  public UnitValue(float paramFloat) { this(paramFloat, null, 0, true, 100, null, null, paramFloat + "px"); }
  
  public UnitValue(float paramFloat, int paramInt, String paramString) { this(paramFloat, null, paramInt, true, 100, null, null, paramString); }
  
  UnitValue(float paramFloat, String paramString1, boolean paramBoolean, int paramInt, String paramString2) { this(paramFloat, paramString1, -1, paramBoolean, paramInt, null, null, paramString2); }
  ...
  public final int getPixels(float paramFloat, ContainerWrapper paramContainerWrapper, ComponentWrapper paramComponentWrapper) { return Math.round(getPixelsExact(paramFloat, paramContainerWrapper, paramComponentWrapper)); }
    ...
    if (this.oper == 100) {
      ...
      switch (this.unit) {
        ...
        case 7:
          ...
          float = this.isHor ? PlatformDefaults.getHorizontalScaleFactor() : PlatformDefaults.getVerticalScaleFactor();
          if (float != null)
            f1 *= float.floatValue(); 
  ...
  private int parseUnitString() {
    ...
    Integer integer = (Integer)UNIT_MAP.get(this.unitStr);
    if (integer != null)
  ...
  final boolean isLinked() { return (this.linkId != null); }
  
  final boolean isLinkedDeep() {
    if (this.subUnits == null)
      return (this.linkId != null); 
    for (byte b = 0; b < this.subUnits.length; b++) {
      if (this.subUnits[b].isLinkedDeep())
        return true; 
    } 
    return false;
  }
  
  final String getLinkTargetId() { return this.linkId; }
  
  final UnitValue getSubUnitValue(int paramInt) { return this.subUnits[paramInt]; }
  
  final int getSubUnitCount() { return (this.subUnits != null) ? this.subUnits.length : 0; }
  
  public final UnitValue[] getSubUnits() { return (this.subUnits != null) ? (UnitValue[])this.subUnits.clone() : null; }
  
  public final int getUnit() { return this.unit; }
  
  public final String getUnitString() { return this.unitStr; }
  
  public final int getOperation() { return this.oper; }
  
  public final float getValue() { return this.value; }
  
  public final boolean isHorizontal() { return this.isHor; }
  
  public final String toString() { return getClass().getName() + ". Value=" + this.value + ", unit=" + this.unit + ", unitString: " + this.unitStr + ", oper=" + this.oper + ", isHor: " + this.isHor; }
  
  public final String getConstraintString() { return LayoutUtil.getCCString(this); }
  
  public final int hashCode() { return (int)(this.value * 12345.0F) + (this.oper >>> 5) + this.unit >>> 17; }
  
  public static void addGlobalUnitConverter(UnitConverter paramUnitConverter) {
    if (paramUnitConverter == null)
      throw new NullPointerException(); 
    CONVERTERS.add(paramUnitConverter);
  }
  
  public static boolean removeGlobalUnitConverter(UnitConverter paramUnitConverter) { return CONVERTERS.remove(paramUnitConverter); }
  
  public static UnitConverter[] getGlobalUnitConverters() { return (UnitConverter[])CONVERTERS.toArray(new UnitConverter[CONVERTERS.size()]); }
  
  public static int getDefaultUnit() { return PlatformDefaults.getDefaultHorizontalUnit(); }
  ...
  private void readObject(ObjectInputStream paramObjectInputStream) throws IOException, ClassNotFoundException { LayoutUtil.setSerializedObject(this, LayoutUtil.readAsXML(paramObjectInputStream)); }
  ...
  static  {
    ...
    ZERO = new UnitValue(0.0F, null, false, true, 100, null, null, "0px");
    ...
    INF = new UnitValue(2097051.0F, null, false, true, 100, null, null, "inf");

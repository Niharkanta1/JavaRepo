...
public final class CC implements Externalizable {
  ...
  private String[] linkTargets = null;
  ...
  public final CC spanY() { return spanY(2097051); }
  ...
  public final CC spanX() { return spanX(2097051); }
  ...
  public final CC push() { return pushX().pushY(); }
  
  public final CC push(Float paramFloat1, Float paramFloat2) { return pushX(paramFloat1).pushY(paramFloat2); }
  
  public final CC pushY() { return pushY(ResizeConstraint.WEIGHT_100); }
  ...
  public final CC pushX() { return pushX(ResizeConstraint.WEIGHT_100); }
  ...
  public final CC x(String paramString) { return corrPos(paramString, 0); }
  
  public final CC y(String paramString) { return corrPos(paramString, 1); }
  
  public final CC x2(String paramString) { return corrPos(paramString, 2); }
  
  public final CC y2(String paramString) { return corrPos(paramString, 3); }
  ...
  public DimConstraint getHorizontal() { return this.hor; }
  
  public void setHorizontal(DimConstraint paramDimConstraint) { this.hor = (paramDimConstraint != null) ? paramDimConstraint : new DimConstraint(); }
  
  public DimConstraint getVertical() { return this.ver; }
  
  public void setVertical(DimConstraint paramDimConstraint) { this.ver = (paramDimConstraint != null) ? paramDimConstraint : new DimConstraint(); }
  
  public DimConstraint getDimConstraint(boolean paramBoolean) { return paramBoolean ? this.hor : this.ver; }
  ...
  public boolean isBoundsInGrid() { return this.boundsInGrid; }
  
  void setBoundsInGrid(boolean paramBoolean) { this.boundsInGrid = paramBoolean; }
  
  public int getCellX() { return this.cellX; }
  
  public void setCellX(int paramInt) { this.cellX = paramInt; }
  
  public int getCellY() { return (this.cellX < 0) ? -1 : this.cellY; }
  ...
  public int getDockSide() { return this.dock; }
  ...
  public void setExternal(boolean paramBoolean) { this.external = paramBoolean; }
  
  public Boolean getFlowX() { return this.flowX; }
  
  public void setFlowX(Boolean paramBoolean) { this.flowX = paramBoolean; }
  
  public int getHideMode() { return this.hideMode; }
  ...
  public void setSkip(int paramInt) { this.skip = paramInt; }
  
  public int getSpanX() { return this.spanX; }
  
  public void setSpanX(int paramInt) { this.spanX = paramInt; }
  
  public int getSpanY() { return this.spanY; }
  
  public void setSpanY(int paramInt) { this.spanY = paramInt; }
  
  public Float getPushX() { return this.pushX; }
  
  public void setPushX(Float paramFloat) { this.pushX = paramFloat; }
  
  public Float getPushY() { return this.pushY; }
  
  public void setPushY(Float paramFloat) { this.pushY = paramFloat; }
  
  public int getSplit() { return this.split; }
  
  public void setSplit(int paramInt) { this.split = paramInt; }
  
  public String getTag() { return this.tag; }
  
  public void setTag(String paramString) { this.tag = paramString; }
  
  public boolean isWrap() { return (this.wrap != null); }
  
  public void setWrap(boolean paramBoolean) { this.wrap = paramBoolean ? ((this.wrap == null) ? DEF_GAP : this.wrap) : null; }
  
  public BoundSize getWrapGapSize() { return (this.wrap == DEF_GAP) ? null : this.wrap; }
  
  public void setWrapGapSize(BoundSize paramBoundSize) { this.wrap = (paramBoundSize == null) ? ((this.wrap != null) ? DEF_GAP : null) : paramBoundSize; }
  
  public boolean isNewline() { return (this.newline != null); }
  
  public void setNewline(boolean paramBoolean) { this.newline = paramBoolean ? ((this.newline == null) ? DEF_GAP : this.newline) : null; }
  
  public BoundSize getNewlineGapSize() { return (this.newline == DEF_GAP) ? null : this.newline; }
  
  public void setNewlineGapSize(BoundSize paramBoundSize) { this.newline = (paramBoundSize == null) ? ((this.newline != null) ? DEF_GAP : null) : paramBoundSize; }

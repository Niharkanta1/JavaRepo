...
public class BoundSize implements Serializable {
  ...
  private final UnitValue min;
  
  private final UnitValue pref;
  
  private final UnitValue max;
  
  private final boolean gapPush;
  
  private static final long serialVersionUID = 1L;
  
  public BoundSize(UnitValue paramUnitValue, String paramString) { this(paramUnitValue, paramUnitValue, paramUnitValue, paramString); }
  
  public BoundSize(UnitValue paramUnitValue1, UnitValue paramUnitValue2, UnitValue paramUnitValue3, String paramString) { this(paramUnitValue1, paramUnitValue2, paramUnitValue3, false, paramString); }
  ...
  public final UnitValue getMin() { return this.min; }
  
  public final UnitValue getPreferred() { return this.pref; }
  
  public final UnitValue getMax() { return this.max; }
  
  public boolean getGapPush() { return this.gapPush; }
  
  public boolean isUnset() { return (this == ZERO_PIXEL || (this.pref == null && this.min == null && this.max == null && !this.gapPush)); }
  ...
  final int[] getPixelSizes(float paramFloat, ContainerWrapper paramContainerWrapper, ComponentWrapper paramComponentWrapper) { return new int[] { (this.min != null) ? this.min.getPixels(paramFloat, paramContainerWrapper, paramComponentWrapper) : 0, (this.pref != null) ? this.pref.getPixels(paramFloat, paramContainerWrapper, paramComponentWrapper) : 0, (this.max != null) ? this.max.getPixels(paramFloat, paramContainerWrapper, paramComponentWrapper) : 2097051 }; }
  ...
  protected Object readResolve() throws ObjectStreamException { return LayoutUtil.getSerializedObject(this); }

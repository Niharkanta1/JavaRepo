...
public final class PlatformDefaults {
  ...
  private static final UnitValue LPX4 = new UnitValue(4.0F, true, null);
  
  private static final UnitValue LPX6 = new UnitValue(6.0F, true, null);
  
  private static final UnitValue LPX7 = new UnitValue(7.0F, true, null);
  
  private static final UnitValue LPX9 = new UnitValue(9.0F, true, null);
  
  private static final UnitValue LPX10 = new UnitValue(10.0F, true, null);
  
  private static final UnitValue LPX11 = new UnitValue(11.0F, true, null);
  
  private static final UnitValue LPX12 = new UnitValue(12.0F, true, null);
  
  private static final UnitValue LPX14 = new UnitValue(14.0F, true, null);
  
  private static final UnitValue LPX16 = new UnitValue(16.0F, true, null);
  
  private static final UnitValue LPX18 = new UnitValue(18.0F, true, null);
  
  private static final UnitValue LPX20 = new UnitValue(20.0F, true, null);
  ...
  public static void setPlatform(int paramInt) {
    switch (paramInt) {
      case 0:
        ...
        setMinimumButtonWidth(new UnitValue(75.0F, true, null));
      ...
      case 1:
        ...
        setGridCellGap(LPX4, LPY4);
        setMinimumButtonWidth(new UnitValue(68.0F, true, null));
      ...
      case 2:
        ...
        setMinimumButtonWidth(new UnitValue(85.0F, true, null));
  ...
  public static int getPlatform() { return CUR_PLAF; }
  
  public static int getDefaultDPI() { return BASE_DPI; }
  ...
  public static Float getHorizontalScaleFactor() { return horScale; }
  ...
  public static Float getVerticalScaleFactor() { return verScale; }
  ...
  public static int getLogicalPixelBase() { return LP_BASE; }
  ...
  public static void setParagraphGap(UnitValue paramUnitValue1, UnitValue paramUnitValue2) { setUnitValue(new String[] { "p", "para", "paragraph" }, paramUnitValue1, paramUnitValue2); }
  
  public static void setIndentGap(UnitValue paramUnitValue1, UnitValue paramUnitValue2) { setUnitValue(new String[] { "i", "ind", "indent" }, paramUnitValue1, paramUnitValue2); }
  ...
  public static UnitValue getMinimumButtonWidth() { return BUTT_WIDTH; }
  
  public static UnitValue getUnitValueX(String paramString) { return (UnitValue)HOR_DEFS.get(paramString); }
  
  public static UnitValue getUnitValueY(String paramString) { return (UnitValue)VER_DEFS.get(paramString); }
  ...
  public static final void setUnitValue(String[] paramArrayOfString, UnitValue paramUnitValue1, UnitValue paramUnitValue2) {
    for (byte b = 0; b < paramArrayOfString.length; b++) {
      String str = paramArrayOfString[b].toLowerCase().trim();
      if (paramUnitValue1 != null)
  ...
  static final int convertToPixels(float paramFloat1, String paramString, boolean paramBoolean, float paramFloat2, ContainerWrapper paramContainerWrapper, ComponentWrapper paramComponentWrapper) {
    UnitValue unitValue = (UnitValue)(paramBoolean ? HOR_DEFS : VER_DEFS).get(paramString);
  ...
  public static final String getButtonOrder() { return BUTTON_FORMAT; }
  ...
  public static BoundSize getGridGapX() { return DEF_HGAP; }
  
  public static BoundSize getGridGapY() { return DEF_VGAP; }
  
  public static UnitValue getDialogInsets(int paramInt) { return DIALOG_INS[paramInt]; }
  ...
  public static UnitValue getPanelInsets(int paramInt) { return PANEL_INS[paramInt]; }
  ...
  public static float getLabelAlignPercentage() { return (CUR_PLAF == 1) ? 1.0F : 0.0F; }
  
  static BoundSize getDefaultComponentGap(ComponentWrapper paramComponentWrapper1, ComponentWrapper paramComponentWrapper2, int paramInt, String paramString, boolean paramBoolean) { return (GAP_PROVIDER != null) ? GAP_PROVIDER.getDefaultGap(paramComponentWrapper1, paramComponentWrapper2, paramInt, paramString, paramBoolean) : ((paramComponentWrapper2 == null) ? null : ((paramInt == 2 || paramInt == 4) ? RELATED_X : RELATED_Y)); }
  
  public static InCellGapProvider getGapProvider() { return GAP_PROVIDER; }
  
  public static void setGapProvider(InCellGapProvider paramInCellGapProvider) { GAP_PROVIDER = paramInCellGapProvider; }
  
  public static int getModCount() { return MOD_COUNT; }
  
  public void invalidate() { MOD_COUNT++; }
  
  public static final int getDefaultHorizontalUnit() { return DEF_H_UNIT; }
  ...
  public static final int getDefaultVerticalUnit() { return DEF_V_UNIT; }
  ...
  public static boolean getDefaultRowAlignmentBaseline() { return dra; }
  
  public static void setDefaultRowAlignmentBaseline(boolean paramBoolean) { dra = paramBoolean; }

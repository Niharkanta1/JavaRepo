...
public final class AC implements Externalizable {
  ...
  public AC() { this.cList.add(new DimConstraint()); }
  
  public final DimConstraint[] getConstaints() { return (DimConstraint[])this.cList.toArray(new DimConstraint[this.cList.size()]); }
  ...
  public final void setConstaints(DimConstraint[] paramArrayOfDimConstraint) {
    ...
    for (byte b = 0; b < paramArrayOfDimConstraint.length; b++)
      this.cList.add(paramArrayOfDimConstraint[b]); 
  }
  
  public int getCount() { return this.cList.size(); }
  ...
  public final AC noGrid() { return noGrid(new int[] { this.curIx }); }
  ...
  public final AC fill() { return fill(new int[] { this.curIx }); }
  ...
  public final AC sizeGroup() { return sizeGroup("", new int[] { this.curIx }); }
  
  public final AC sizeGroup(String paramString) { return sizeGroup(paramString, new int[] { this.curIx }); }
  ...
  public final AC size(String paramString) { return size(paramString, new int[] { this.curIx }); }
  ...
  public final AC gap(String paramString) { return gap(paramString, new int[] { this.curIx++ }); }
  ...
  public final AC align(String paramString) { return align(paramString, new int[] { this.curIx }); }
  ...
  public final AC growPrio(int paramInt) { return growPrio(paramInt, new int[] { this.curIx }); }
  ...
  public final AC grow() { return grow(1.0F, new int[] { this.curIx }); }
  
  public final AC grow(float paramFloat) { return grow(paramFloat, new int[] { this.curIx }); }
  
  public final AC grow(float paramFloat, int... paramVarArgs) {
    Float float = new Float(paramFloat);
    for (int i = paramVarArgs.length - 1; i >= 0; i--) {
      int j = paramVarArgs[i];
      makeSize(j);
      ((DimConstraint)this.cList.get(j)).setGrow(float);
    } 
    return this;
  }
  
  public final AC shrinkPrio(int paramInt) { return shrinkPrio(paramInt, new int[] { this.curIx }); }
  ...
  public final AC shrink() { return shrink(100.0F, new int[] { this.curIx }); }
  
  public final AC shrink(float paramFloat) { return shrink(paramFloat, new int[] { this.curIx }); }
  ...
  public final AC shrink(float paramFloat, int... paramVarArgs) {
    ...
    for (int i = paramVarArgs.length - 1; i >= 0; i--) {
      int j = paramVarArgs[i];
      makeSize(j);
      ((DimConstraint)this.cList.get(j)).setShrink(float);
    } 
    return this;
  }
  
  public final AC shrinkWeight(float paramFloat) { return shrink(paramFloat); }
  
  public final AC shrinkWeight(float paramFloat, int... paramVarArgs) { return shrink(paramFloat, paramVarArgs); }
